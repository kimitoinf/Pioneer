...
public class PlayerAttributes
{
	...
	public static final PlayerAttribute ATTACK_DAMAGE = register(new PlayerAttribute("attack_damage", EntityAttributes.GENERIC_ATTACK_DAMAGE.setTracked(true)));
	...
	public static final PlayerAttribute KNOCKBACK_RESISTANCE = register(new PlayerAttribute("knockback_resistance", EntityAttributes.GENERIC_KNOCKBACK_RESISTANCE.setTracked(true)));
